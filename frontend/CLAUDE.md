...
```bash
pnpm test                              # 396 testes (domain + services + components + hooks + stress)
...
| `__tests__/components/AdamBotVoice.test.ts` | 15 | TTS masculina + seleção de voz + STT |
