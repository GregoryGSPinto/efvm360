// ============================================================================
// VFZ Backend — Controller de Passagens de Serviço
// ============================================================================
...
export const salvar = async (req: Request, res: Response): Promise<void> => {
  ...
  // Busca IDs dos operadores por matrícula
  ...
  await auditService.registrar({
    ...
    acao: passagemUuid ? 'PASSAGEM_CRIADA' : 'PASSAGEM_CRIADA',
    recurso: 'passagem',
...
/**
 * POST /api/v1/passagens/:uuid/assinar — Assinar passagem com verificação de senha server-side
 */
