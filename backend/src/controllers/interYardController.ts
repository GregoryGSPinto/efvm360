...
export const create = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ error: 'Erro interno ao criar handover inter-pátio' });
  }
};
...
export const dispatch = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ error: 'Erro interno ao despachar handover' });
  }
};
...
export const receive = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ error: 'Erro interno ao receber handover' });
  }
};
...
export const addDivergence = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ error: 'Erro interno ao adicionar divergência' });
  }
};
...
export const resolve = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ error: 'Erro interno ao resolver divergência' });
  }
};
...
export const seal = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ error: 'Erro interno ao selar handover' });
  }
};
...
export const list = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    res.status(500).json({ error: 'Erro interno ao listar handovers' });
  }
};
